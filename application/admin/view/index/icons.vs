<div id="wrap">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav" id="main-nav">
                    <li class="hidden-sm"><a href="#wrap">首页</a></li>
                    <li class="hidden-sm active">
                        <a href="#why">选我！</a>
                    </li>
                    <li class="dropdown-split-left"><a href="#new">图标</a></li>
                    <li class="dropdown dropdown-split-right hidden-xs">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-caret-down"></i> </a>
                        <ul class="dropdown-menu pull-right">
                            <li class="dropdown-header"><i class="fa fa-flag fa-fw"></i>&nbsp; 图标</li>
                            <li class="divider"></li>
                            <li class=""><a href="#new"><i class="fa fa-handshake-o fa-fw"></i>&nbsp; 4.7.0版新增</a></li>
                            <li class=""><a href="#web-application"><i class="fa fa-camera-retro fa-fw"></i>&nbsp; 网页</a></li>
                            <li><a href="#hand"><i class="fa fa-hand-o-right fa-fw"></i>&nbsp; 手势</a></li>
                            <li class=""><a href="#accessibility"><i class="fa fa-universal-access fa-fw"></i>&nbsp; 辅助功能</a></li>
                            <li><a href="#transportation"><i class="fa fa-ship fa-fw"></i>&nbsp; 运输</a></li>
                            <li class=""><a href="#gender"><i class="fa fa-venus-mars fa-fw"></i>&nbsp; 性别</a></li>
                            <li class=""><a href="#file-type"><i class="fa fa-file-image-o fa-fw"></i>&nbsp; 文件类型</a></li>
                            <li><a href="#spinner"><i class="fa fa-spinner fa-fw"></i>&nbsp; 可旋转</a></li>
                            <li class=""><a href="#form-control"><i class="fa fa-check-square fa-fw"></i>&nbsp; 表单</a></li>
                            <li><a href="#payment"><i class="fa fa-paypal fa-fw"></i>&nbsp; 支付</a></li>
                            <li class=""><a href="#chart"><i class="fa fa-line-chart fa-fw"></i>&nbsp; 图表</a></li>
                            <li class=""><a href="#currency"><i class="fa fa-won fa-fw"></i>&nbsp; 货币</a></li>
                            <li class=""><a href="#text-editor"><i class="fa fa-file-text-o fa-fw"></i>&nbsp; 文本编辑</a></li>
                            <li class=""><a href="#directional"><i class="fa fa-hand-o-right fa-fw"></i>&nbsp; 指示方向</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8 text-center">
                    ...
                    <div class="actions">
                        <a class="btn btn-default btn-lg" href="./assets/font-awesome-4.7.0.zip"> <i class="fa fa-download fa-lg"></i>&nbsp;&nbsp; 立即下载 </a>
                    </div>
                    <div class="shameless-self-promotion">
                        Version 4.7.0 &nbsp;&nbsp;·&nbsp;&nbsp;
                        <a href="https://github.com/FortAwesome/Font-Awesome" onclick="_gaq.push(['_trackEvent', 'Outbound Link', 'View Project on GitHub']);" target="_blank"> GitHub项目</a> &nbsp;&nbsp;·&nbsp;&nbsp;
                        <a href="http://fontawesome.io/3.2.1">Old 3.2.1 Docs</a> &nbsp;&nbsp;·&nbsp;&nbsp; 作者 <a href="http://twitter.com/davegandy" target="_blank">Dave Gandy</a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div id="icon-carousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="item">
                                <div><i class="fa fa-font-awesome" aria-hidden="true"></i><span class="sr-only">flag icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-universal-access" aria-hidden="true"></i><span class="sr-only">fort awesome icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-fort-awesome" aria-hidden="true"></i><span class="sr-only">fort awesome icon</span></div>
                            </div>
                            <div class="item active">
                                <div><i class="fa fa-commenting" aria-hidden="true"></i><span class="sr-only">commenting icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-map-signs" aria-hidden="true"></i><span class="sr-only">map signs icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-envelope" aria-hidden="true"></i><span class="sr-only">envelope icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-send-o" aria-hidden="true"></i><span class="sr-only">send icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-book" aria-hidden="true"></i><span class="sr-only">book icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-fighter-jet" aria-hidden="true"></i><span class="sr-only">fighter jet icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-beer" aria-hidden="true"></i><span class="sr-only">beer icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-heart-o" aria-hidden="true"></i><span class="sr-only">heart icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-thumbs-o-up" aria-hidden="true"></i><span class="sr-only">thumbs up icon</span></div>
                            </div>
                            <div class="item">
                                <div><i class="fa fa-pied-piper-alt" aria-hidden="true"></i><span class="sr-only">pied piper icon</span></div>
                            </div>
                        </div>
                        <a class="carousel-control left" href="#icon-carousel" data-slide="prev" onclick="_gaq.push(['_trackEvent', 'iconCarousel', 'Prev']);"> <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> <span class="sr-only">Previous</span> </a>
                        <a class="carousel-control right" href="#icon-carousel" data-slide="next" onclick="_gaq.push(['_trackEvent', 'iconCarousel', 'Next']);"> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <span class="sr-only">Next</span> </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <section id="why" class="mainParts">
            <section class="hidden-print">
                <div class="stripe-ad row">
                    <p class="lead col-md-8">
                        Font Awesome为您提供可缩放的矢量图标，您可以使用CSS所提供的所有特性对它们进行更改，包括：大小、颜色、阴影或者其它任何支持的效果。
                    </p>
                    <div id="carbonads" class="col-md-4">
                        <span class="carbon-wrap">
                            <a class="carbon-img col-md-3 hidden-sm hidden-xs" href="http://github.dashgame.com" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" class="octicon octicon-mark-github" aria-hidden="true" viewBox="0 0 16 16" version="1.1">
                            ...
                            <a class="carbon-text col-md-9 col-xs-12" href="http://github.dashgame.com" target="_blank">
                                <h4>Github热门</h4>
                                <p>一起来探索GitHub上最热门的项目吧！</p>
                            </a>
                        </span>
                    </div>
                </div>
            ...
            <section class="feature-list">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-flag"></i> 一个字库，675个图标</h4> 仅一个Font Awesome字库，就包含了与网页相关的所有形象图标。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-ban"></i> 无需依赖JavaScript</h4> Font Awesome完全不依赖JavaScript，因此无需担心兼容性。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-arrows-alt"></i> 无限缩放</h4> 无论在任何尺寸下，可缩放的矢量图形都会为您呈现出完美的图标。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-microphone"></i> 如言语一般自由</h4> Font Awesome完全免费，哪怕是商业用途。请查看<a href="#license">许可</a>。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-pencil"></i> CSS控制</h4> 只要CSS支持，无论颜色、大小、阴影或者其它任何效果，都可以轻易展现。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-eye"></i> 高分屏完美呈现</h4> Font Awesome的矢量图标，将使您的网站在视网膜级的高分屏上大放异彩。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-gamepad"></i> 完美兼容其它框架</h4> 尽管是为
                        <a href="http://getbootstrap.com">Bootstrap</a>设计，但Font Awesome同样能与其它框架完美协同运作。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-desktop"></i> 可用于桌面系统</h4> 用于桌面系统，或需要一套完整的矢量图，请查看
                        <a href="http://fontawesome.io/cheatsheet/" target="_blank">备忘</a>。
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <h4><i class="fa fa-search"></i> 可适配于屏幕阅读器</h4> 与其它字体不同，Font Awesome不会影响屏幕阅读器正常工作。
                    </div>
                </div>
            </section>
            <div class="clearfix"></div>
            <div class="baidushare">
                <div class="pull-left"><i class="fa fa-share-alt"></i> 分享给朋友</div>
                <div class="bdsharebuttonbox pull-left bdshare-button-style2-16" data-bd-bind="1517475536830"><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a><a href="#" class="bds_diandian" data-cmd="diandian" title="分享到点点网"></a><a href="#" class="bds_more" data-cmd="more"></a></div>
                <script>
        ...
        <div>
            ...
            <section id="spinner" class="mainParts">
                ...
                <div class="alert alert-success">
                    <ul class="fa-ul">
                        <li>
                            <i class="fa fa-info-circle fa-lg fa-li"></i> 这些图标在
                            <code>fa-spin</code>类的作用下表现优异。您可以查阅
            ...
            <section id="brand" class="mainParts">
                ...
                <div class="alert alert-warning">
                    <h4><i class="fa fa-warning"></i> 特别注意!</h4> Adblock Plus 插件会通过设置“Remove Social Media Buttons”来移除 Font Awesome 的这些标志图标。 然而我们并不会用一些特殊方法来强行显示。如果您认为这是一个错误，请
                    <a href="https://adblockplus.org/en/bugs" class="alert-link" target="_blank">向 Adblock Plus 报告这个问题</a>。 在Adblock Plus修复这个问题之前，您需要自行修改这些图标的类名来解决这个问题。
                </div>
        ...
        <section id="getstart" class="mainParts">
            <div id="bootstrapcdn">
                <h2 class="page-header">最简单的方式：<a href="http://www.bootstrapcdn.com/#fontawesome_tab" target="_blank">BootstrapCDN</a> （由<a href="http://maxcdn.com">MaxCDN</a>提供）</h2>
            ...
            <section id="default-css">
                ...
                <p>如果您使用了默认的Bootstrap CSS样式，那么你可以使用这种方式来引入默认的Font Awesome CSS样式。</p>
                <ol>
                    ...
                    <li>参考<a href="#basic">示例</a>，然后开始使用Font Awesome吧!</li>
                </ol>
            </section>
            <section id="ruby-gem-less">
                <h2 class="page-header">简单方式之二：<a href="https://github.com/FortAwesome/font-awesome-less" target="_blank">LESS Ruby Gem</a></h2>
                <p>
                    使用 <a href="https://github.com/FortAwesome/font-awesome-less" target="_blank">官方 Font Awesome LESS Ruby Gem</a> 可以简单方便的将 Font Awesome LESS 集成到Rails项目中。由 <a href="https://twitter.com/supercodepoet/">@supercodepoet</a> 维护。
                </p>
                <ol>
                    <li>
            ...
            <section id="ruby-gem-sass">
                <h2 class="page-header">简单方式之三：<a href="https://github.com/FortAwesome/font-awesome-sass" target="_blank">SASS Ruby Gem</a></h2>
                <p>
                    使用 <a href="https://github.com/FortAwesome/font-awesome-sass" target="_blank">官方 Font Awesome SASS Ruby Gem</a> 可以简单方便的将 Font Awesome SASS 集成到Rails项目中。由 <a href="https://twitter.com/supercodepoet/">@supercodepoet</a> 维护。
                </p>
                <ol>
                    <li>
                        将下面这行代码加入到应用的Gemfile中：
            ...
            <section id="custom-less">
                <h2 class="page-header">进阶方式：自定义 LESS 或 SASS</h2>
                <p>使用LESS或SASS的方法来自定义 Font Awesome 4.7.0 。</p>
                <ol>
                    <li>复制 <code>font-awesome/</code> 目录到您的项目中。</li>
                    <li>
                        打开 <code>font-awesome/less/variables.less</code> 文件或 <code>font-awesome/scss/_variables.scss</code>文件 ，然后修改 <code>@fa-font-path</code> 或 <code>$fa-font-path</code> 为您的字体目录。
                        ...
                        <p class="alert alert-success"><i class="fa fa-info-circle"></i> 字体路径是相对于编译的CSS目录。</p>
                    </li>
                    <li>如果使用了静态编译器，那么重新编译LESS或SASS文件。如果没有，那么现在应该一切OK了。</li>
                    <li>参考<a href="#basic">示例</a>，然后开始使用Font Awesome吧!</li>
                </ol>
            </section>
            <section class="need-ie7">
                ...
                <p>
                    如果需要支持IE7，那真的十分抱歉。Font Awesome从4.1.0版本开始不再支持IE7， 但更早的版本仍然支持。您可以查看
                    <a href="http://fontawesome.io/3.2.1/get-started/#need-ie7">3.2.1 的IE7支持说明</a>。 然后呢，您可以去找那个非要支持IE7的人算账 :)
                </p>
            </section>
        </section>
    </div>
    <div class="container">
        <section id="basic" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        您可以将Font Awesome图标使用在几乎任何地方，只需要使用CSS前缀 <code>fa</code> ，再加上图标名称。 Font Awesome是为使用内联元素而设计的。我们通常更喜欢使用 <code>&lt;i&gt;</code> ，因为它更简洁。 但实际上使用 <code>&lt;span&gt;</code> 才能更加语义化。
                    </p>
                    ...
                    <div class="alert alert-success">
                        <ul class="fa-ul">
                            <li>
                                <i class="fa fa-info-circle fa-lg fa-li"></i> 如果您修改了图标容器的字体大小，图标大小会随之改变。同样的变化也会发生在颜色、阴影等其它任何CSS支持的效果上。
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section id="larger" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        使用 <code>fa-lg</code> (33%递增)、<code>fa-2x</code>、
                        <code>fa-3x</code>、<code>fa-4x</code>，或者 <code>fa-5x</code> 类 来放大图标。
                    </p>
                    <div class="highlight">
                    ...
                    <div class="alert alert-success">
                        <ul class="fa-ul">
                            <li>
                                <i class="fa fa-exclamation-triangle fa-li fa-lg"></i> 如果图标的底部和顶部被截断了，您需要增加行高来解决此问题。
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="list-group">
                        <a class="list-group-item" href="javascript:;"><i class="fa fa-home fa-fw"></i>&nbsp; Home</a>
                        <a class="list-group-item" href="javascript:;"><i class="fa fa-book fa-fw"></i>&nbsp; Library</a>
                        <a class="list-group-item" href="javascript:;"><i class="fa fa-pencil fa-fw"></i>&nbsp; Applications</a>
                        <a class="list-group-item" href="javascript:;"><i class="fa fa-cog fa-fw"></i>&nbsp; Settings</a>
                    </div>
                </div>
                <div class="col-md-9 col-sm-8">
                    <p>
                        使用 <code>fa-fw</code> 可以将图标设置为一个固定宽度。主要用于不同宽度图标无法对齐的情况。 尤其在列表或导航时起到重要作用。
                    </p>
                    <div class="highlight">
        ...
        <section id="list" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>使用 <code>fa-ul</code> 和 <code>fa-li</code> 便可以简单的将无序列表的默认符号替换掉。</p>
                    <div class="highlight"><pre><code class="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"fa-ul"</span><span class="nt">&gt;</span><br>&nbsp;&nbsp;<span class="nt">&lt;li&gt;&lt;i</span> <span class="na">class=</span><span class="s">"fa-li fa fa-check-square"</span><span class="nt">&gt;&lt;/i&gt;</span>List icons<span class="nt">&lt;/li&gt;</span><br>&nbsp;&nbsp;<span class="nt">&lt;li&gt;&lt;i</span> <span class="na">class=</span><span class="s">"fa-li fa fa-check-square"</span><span class="nt">&gt;&lt;/i&gt;</span>can be used<span class="nt">&lt;/li&gt;</span><br>&nbsp;&nbsp;<span class="nt">&lt;li&gt;&lt;i</span> <span class="na">class=</span><span class="s">"fa-li fa fa-spinner fa-spin"</span><span class="nt">&gt;&lt;/i&gt;</span>as bullets<span class="nt">&lt;/li&gt;</span><br>&nbsp;&nbsp;<span class="nt">&lt;li&gt;&lt;i</span> <span class="na">class=</span><span class="s">"fa-li fa fa-square"</span><span class="nt">&gt;&lt;/i&gt;</span>in lists<span class="nt">&lt;/li&gt;</span><br><span class="nt">&lt;/ul&gt;</span></code> </pre>
                    </div>
                </div>
            </div>
        </section>
        <section id="bordered-pulled" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        使用 <code>fa-border</code> 以及 <code>pull-right</code> 或 <code>pull-left</code> 可以轻易构造出引用的特殊效果。
                    </p>
        ...
        <section id="animated" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        使用 <code>fa-spin</code> 类来使任意图标旋转，现在您还可以使用 <code>fa-pulse</code> 来使其进行8方位旋转。尤其适合 <code>fa-spinner</code>、<code>fa-refresh</code> 和 <code>fa-cog</code> 。
                    </p>
        ...
        <section id="rotated-flipped" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        使用 <code>fa-rotate-*</code> 和 <code>fa-flip-*</code> 类可以对图标进行任意旋转和翻转。
                    </p>
        ...
        <section id="stacked" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>
                        如果想要将多个图标组合起来，使用 <code>fa-stack</code> 类作为父容器， <code>fa-stack-1x</code> 作为正常比例的图标，
                        <code>fa-stack-2x</code> 作为大一些的图标。还可以使用 <code>fa-inverse</code> 类来切换图标颜色。您可以在父容器中 通过添加 <a href="#larger">大图标</a> 类来控制整体大小。
                    </p>
        ...
        <section id="bootstrap" class="mainParts">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <p>
                        <a class="btn btn-danger" href="javascript:;"> <i class="fa fa-trash-o fa-lg"></i> Delete</a> <a class="btn btn-default btn-sm" href="javascript:;"> <i class="fa fa-cog"></i> Settings</a> </p>
                    <p>
                        <a class="btn btn-lg btn-success" href="javascript:;"> <i class="fa fa-flag fa-2x pull-left"></i> Font Awesome<br>Version 4.7.0</a> </p>
                    <div class="margin-bottom">
                        <div class="btn-group">
                    ...
                    <div class="margin-bottom">
                        <div class="btn-group open">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="col-xs-11"><i class="fa fa-pencil fa-fw"></i> Edit</a></li>
                                <li><a class="col-xs-11"><i class="fa fa-trash-o fa-fw"></i> Delete</a></li>
                                <li><a class="col-xs-11"><i class="fa fa-ban fa-fw"></i> Ban</a></li>
                                <li class="divider"></li>
                                <li><a class="col-xs-11"><i class="i"></i> Make admin</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section id="custom" class="mainParts">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                    <p>星级评定（受 <a href="http://css-tricks.com/star-ratings/" target="_blank">CSS Tricks</a> 所启发）</p>
                    <div class="well">
                        <span class="rating"> <span class="star"></span><span class="star"></span><span class="star"></span><span class="star"></span><span class="star"></span>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <section id="community" class="mainParts">
            <h2 class="page-header">获取帮助</h2>
            <p>
                使用Font Awesome的过程中遇到困难了？亦或碰到一个您认为没有正确显示的问题？很抱歉我没有时间来一一回复大家的邮件。 不过以下方式可能对您的情况有所帮助：
            </p>
            <ol>
                <li>
                    您可以阅读最新版本的怎样<a href="#getstart">起步</a>. 它将用最简单的方式告诉您怎样使用Font Awesome。
                </li>
                <li>
                    查阅Stack Overflow上 <a href="http://stackoverflow.com/questions/tagged/font-awesome" target="_blank"> Font Awesome的相关问题</a>。其他人或许也有与您相同的问题。
                </li>
                <li>
                    在Stack Overflow上也找不到问题的答案？ 那么可以
                    <a href="http://stackoverflow.com/questions/ask?tags=font-awesome" target="_blank">提出一个新问题</a>，然后
                    <a href="mailto:dave@fontawesome.io">给我发送邮件</a> ，我或许有时间会看一看。
                </li>
            </ol>
        </section>
        <section id="reporting-bugs" class="mainParts">
            <h2 class="page-header">报告Bug</h2>
            <p>
                找到Font Awesome的Bug了？那么请直接在GitHub项目中报告就是了。不过请注意以下几点：
            </p>
            <ol>
                <li>请表现得友好一些。Font Awesome是一个有爱的地方:)</li>
                <li>请先 <a href="https://github.com/FortAwesome/Font-Awesome/search?type=Issues" target="_blank">搜索</a> 一下，也许这个Bug已经有人提交过了。</li>
                <li>
                    在提交任何问题之前，请先阅读由 <a href="https://github.com/necolas/" target="_blank">Nicolas Gallagher</a> 编写的 <a href="https://github.com/necolas/issue-guidelines" target="_blank">issue guidelines</a>
                </li>
                <li>
                    如果以上几点都OK了，那么请
                    <a href="https://github.com/FortAwesome/Font-Awesome/issues/new" target="_blank">提交您的问题</a>。
                </li>
            </ol>
        </section>
        <section id="requesting-new-icons" class="mainParts">
            <h2 class="page-header">需要新图标</h2>
            <p>
                新图标几乎都是在
                <a href="https://github.com/FortAwesome/Font-Awesome/issues" target="_blank">Font Awesome GitHub项目</a>中提出需求的。 如果您也需要，那么这里有一些注意事项需要看看：
            </p>
            <ol>
                <li>请表现得友好一些。Font Awesome是一个有爱的地方;)</li>
                <li>请先 <a href="https://github.com/FortAwesome/Font-Awesome/search?type=Issues" target="_blank">搜索</a> 一下，也许您想增加的图标已经有人提交过了。</li>
                <li>
                    请在提出需求时注意以下几点，万分感激：
                    <ul>
                        <li>
                            为 <a href="https://github.com/FortAwesome/Font-Awesome/issues/new?title=Icon%20Request:%20icon-name" target="_blank">新需求</a> 添加标题
                            <code>Icon request: 图标名称</code>.
                        </li>
                        <li>举例说明一下您需要在哪些地方用到这个图标，怎么用？</li>
                        <li>提交一两张单色图片，并确保这张图片能表达您所想要的内容。</li>
                    </ul>
                </li>
                <li>
                    具象化的对象将会诞生出优质的图标，而抽象的概念当然只能用抽象的内容来表现。 举个栗子，一个来表现幸福感的图标远不如一个笑脸图标好制作，也不够直接。 <i class="fa fa-smile"></i>
                </li>
            </ol>
        </section>
        <section id="submitting-pull-requests" class="mainParts">
            <h2 class="page-header">提交请求</h2> 您有解决Font Awesome中Bug的方法？或者您希望为它增添新的特性？非常感谢，但是也需要请您注意几点：
            <ol>
                <li>请不要提交任何新图标。</li>
                ...
                <li>
                    ...
                    <a href="https://github.com/FortAwesome/Font-Awesome/issues/new" target="_blank">submit a pull request</a>.
                </li>
            </ol>
        </section>
        <section id="project-milestones" class="mainParts">
            <h2 class="page-header">项目里程碑</h2>
            <p>
                Want to keep up with what's planned for Font Awesome? Check out our
                <a href="https://github.com/FortAwesome/Font-Awesome/issues/milestones" target="_blank">milestones</a> on the GitHub project.
            </p>
        </section>
    </div>
    <div class="container">
        <section id="license" class="mainParts">
            <h2 class="page-header">字体许可</h2>
            <ul>
                <li>
                ...
                <li>URL: <a href="http://scripts.sil.org/OFL" target="_blank">http://scripts.sil.org/OFL</a></li>
            </ul>
        </section>
        <section class="mainParts">
            <h2 class="page-header">代码许可</h2>
            <ul>
                <li>
                    适用于在以下目录下的所有CSS和LESS文件：
                    <code>font-awesome/css/</code>、
                    <code>font-awesome/less/</code> 以及
                    <code>font-awesome/scss/</code>。
                </li>
                <li>License: MIT License</li>
                <li>URL: <a href="http://opensource.org/licenses/mit-license.html" target="_blank">http://opensource.org/licenses/mit-license.html</a></li>
            </ul>
        </section>
        <section class="mainParts">
            <h2 class="page-header">文档许可</h2>
            <ul>
                <li>适用于所有Font Awesome项目中不受字体和代码许可约束的文件。</li>
                <li>License: CC BY 3.0</li>
                <li>URL: <a href="http://creativecommons.org/licenses/by/3.0/" target="_blank">http://creativecommons.org/licenses/by/3.0/</a></li>
            </ul>
        </section>
        <section class="mainParts">
            <h2 class="page-header">标志</h2>
    ...
    <div class="container margin-bottom-lg">
        <section id="thanks-to" class="mainParts margin-bottom-lg">
            <h2 class="page-header">感谢</h2>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <p>
                        感谢 <a href="https://twitter.com/robmadole/">@robmadole</a> 和
                        <a href="https://twitter.com/supercodepoet/">@supercodepoet</a> 对 图标设计的核查、建议、一些专业帮助，以及自始自终的陪伴。
                    </p>
                </div>
                <div class="col-md-6 col-sm-6">
                    <p>
                        特别感谢 <a href="https://twitter.com/gtagliala">@gtagliala</a> 对于Font Awesome的
                        <a href="https://github.com/FortAwesome/Font-Awesome">GitHub项目</a> 中有关提交请求与意见建议的出色管理。
                    </p>
                </div>
            </div>
        </section>
