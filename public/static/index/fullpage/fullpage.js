...
(function(b) {
    b.fn.fullpage = function(c) {
        ...
        function Y(a) { var d = b(".fp-section.active").find(".fp-slides"); if (d.length && !t) { var e = d.find(".fp-slide.active"),
                    ...
                    f = "prev" === a ? e.siblings(":last") : e.siblings(":first") } t = !0;
                w(d, f) } }
        ...
        function E(a, b) { console && console[a] && console[a]("fullPage: " + b) } c = b.extend({
            menu: !1,
            anchors: [],
            navigation: !1,
        ...
        b.fn.fullpage.reBuild = function(a) {
            ...
            b(".fp-section").each(function() { parseInt(b(this).css("padding-bottom"));
                ...
                b(this).css("height", h + "px"); if (c.scrollOverflow) { var a = b(this).find(".fp-slide");
                    a.length ? a.each(function() { y(b(this)) }) : y(b(this)) } a = b(this).find(".fp-slides");
